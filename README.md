...
- **MQTT auto-discovery** — automatically detects devices published by zigbee2mqtt, ESPHome, RedMatic, evcc and compatible devices and bridges; one click pre-wires all topics and attributes. contin
