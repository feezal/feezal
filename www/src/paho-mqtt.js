...
const Paho = {
    MQTT: (function (global) {
        ...
        var format = function (error, substitutions) {
            ...
            if (substitutions) {
                let field; let start;
                for (const [i, element] of substitutions.entries()) {
                    field = '{' + i + '}';
            ...
            for (let i = 0; i < input.length; i++) {
                ...
                if (charCode >= 0xD800 && charCode <= 0xDBFF) {
                    ...
                    if (isNaN(lowCharCode)) {
                        throw new TypeError(format(ERROR.MALFORMED_UNICODE, [charCode, lowCharCode]));
                    }
        ...
        ClientImpl.prototype._doConnect = function (wsurl) {
            ...
            this.socket.addEventListener('open', scope(this._on_socket_open, this));
            this.socket.addEventListener('message', scope(this._on_socket_message, this));
            this.socket.addEventListener('error', scope(this._on_socket_error, this));
        ...
        ClientImpl.prototype.store = function (prefix, wireMessage) {
            ...
            switch (wireMessage.type) {
                case MESSAGE_TYPE.PUBLISH:
                    ...
                    for (const element of messageBytes) {
                        if (element <= 0xF) {
                ...
                default:
                    throw new Error(format(ERROR.INVALID_STORED_DATA, [key, storedMessage]));
            }
        ...
        ClientImpl.prototype.restore = function (key) {
            ...
            switch (storedMessage.type) {
                ...
                default:
                    throw new Error(format(ERROR.INVALID_STORED_DATA, [key, value]));
            }
        ...
        ClientImpl.prototype._requires_ack = function (wireMessage) {
            ...
            if (messageCount > this.maxMessageIdentifier) {
                throw new Error('Too many messages:' + messageCount);
            }
        ...
        ClientImpl.prototype._receivePublish = function (wireMessage) {
            switch (wireMessage.payloadMessage.qos) {
                ...
                default:
                    throw new Error('Invaild qos=' + wireMmessage.payloadMessage.qos);
            }
        };
        ...
        const Client = function (host, port, path, clientId) {
            ...
            if (typeof host !== 'string') {
                throw new TypeError(format(ERROR.INVALID_TYPE, [typeof host, 'host']));
            }
            ...
            if (arguments.length == 2) {
                ...
                if (typeof path !== 'string') {
                    throw new TypeError(format(ERROR.INVALID_TYPE, [typeof path, 'path']));
                }

                const ipv6AddSBracket = (host.includes(':') && host.slice(0, 1) !== '[' && host.slice(-1) !== ']');
            ...
            this._setOnConnected = function (newOnConnected) {
                if (typeof newOnConnected === 'function') {
                    ...
                    throw new TypeError(format(ERROR.INVALID_TYPE, [typeof newOnConnected, 'onConnected']));
                }
            };
            ...
            this._setOnConnectionLost = function (newOnConnectionLost) {
                if (typeof newOnConnectionLost === 'function') {
                    ...
                    throw new TypeError(format(ERROR.INVALID_TYPE, [typeof newOnConnectionLost, 'onConnectionLost']));
                }
            };
            ...
            this._setOnMessageDelivered = function (newOnMessageDelivered) {
                if (typeof newOnMessageDelivered === 'function') {
                    ...
                    throw new TypeError(format(ERROR.INVALID_TYPE, [typeof newOnMessageDelivered, 'onMessageDelivered']));
                }
            };
            ...
            this._setOnMessageArrived = function (newOnMessageArrived) {
                if (typeof newOnMessageArrived === 'function') {
                    ...
                    throw new TypeError(format(ERROR.INVALID_TYPE, [typeof newOnMessageArrived, 'onMessageArrived']));
                }
            };
            ...
            this._setTrace = function (trace) {
                if (typeof trace === 'function') {
                    ...
                    throw new TypeError(format(ERROR.INVALID_TYPE, [typeof trace, 'onTrace']));
                }
            };
            ...
            this.connect = function (connectOptions) {
                ...
                if (connectOptions.willMessage) {
                    if (!(connectOptions.willMessage instanceof Message)) {
                        throw new TypeError(format(ERROR.INVALID_TYPE, [connectOptions.willMessage, 'connectOptions.willMessage']));
                    }
                    ...
                    if (typeof connectOptions.willMessage.destinationName === 'undefined') {
                        throw new TypeError(format(ERROR.INVALID_TYPE, [typeof connectOptions.willMessage.destinationName, 'connectOptions.willMessage.destinationName']));
                    }
                }
                ...
                if (connectOptions.hosts) {
                    if (!(Array.isArray(connectOptions.hosts))) {
                        throw new TypeError(format(ERROR.INVALID_ARGUMENT, [connectOptions.hosts, 'connectOptions.hosts']));
                    }

                    if (connectOptions.hosts.length === 0) {
                    ...
                    if (!usingURIs) {
                        ...
                        if (!(Array.isArray(connectOptions.ports))) {
                            throw new TypeError(format(ERROR.INVALID_ARGUMENT, [connectOptions.ports, 'connectOptions.ports']));
                        }
            ...
            this.subscribe = function (filter, subscribeOptions) {
                if (typeof filter !== 'string') {
                    throw new TypeError('Invalid argument:' + filter);
                }
            ...
            this.send = function (topic, payload, qos, retained) {
                ...
                if (arguments.length === 0) {
                    ...
                    if (!(topic instanceof Message) && (typeof topic !== 'string')) {
                        throw new TypeError('Invalid argument:' + typeof topic);
                    }

                    message = topic;
                    if (typeof message.destinationName === 'undefined') {
                        throw new TypeError(format(ERROR.INVALID_ARGUMENT, [message.destinationName, 'Message.destinationName']));
                    }
        ...
        var Message = function (newPayload) {
            ...
            this._setDestinationName = function (newDestinationName) {
                if (typeof newDestinationName === 'string') {
                    ...
                    throw new TypeError(format(ERROR.INVALID_ARGUMENT, [newDestinationName, 'newDestinationName']));
                }
            };
            ...
            this._setRetained = function (newRetained) {
                if (typeof newRetained === 'boolean') {
                    ...
                    throw new TypeError(format(ERROR.INVALID_ARGUMENT, [newRetained, 'newRetained']));
                }
            };
