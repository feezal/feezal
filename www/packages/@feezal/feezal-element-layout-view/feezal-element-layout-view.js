...
class FeezalElementLayoutView extends FeezalElement {
...
window.customElements.define('feezal-element-layout-view', FeezalElementLayoutView);

export {FeezalElementLayoutView};