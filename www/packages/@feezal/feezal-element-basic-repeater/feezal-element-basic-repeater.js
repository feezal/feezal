...
class FeezalElementBasicRepeater extends FeezalElement {
    static get feezal() {
        return {
            palette: {
                name: 'Repeater',
...
customElements.define('feezal-element-basic-repeater', FeezalElementBasicRepeater);
export { FeezalElementBasicRepeater };
