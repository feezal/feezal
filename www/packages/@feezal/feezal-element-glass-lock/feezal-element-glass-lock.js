...
class FeezalElementGlassLock extends FeezalElement {
    static get feezal() {
        return {
            palette: {name: 'Lock', category: 'Glass', color: '#7aa5c9', icon: 'lock'},
            description: 'Frosted-glass smart-door-lock card — locked / unlocked / jammed with lock & unlock buttons. ' +
