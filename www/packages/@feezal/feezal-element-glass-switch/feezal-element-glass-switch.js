    ...
    static get feezal() {
        return {
            ...
            attributes: [
                ...
                {name: 'text-on',  type: 'string', default: 'On', defaultI18n: {de: 'Ein'},  help: 'State text while on.'},
                {name: 'text-off', type: 'string', default: 'Off', defaultI18n: {de: 'Aus'}, help: 'State text while off.'},
