...
// ─── Arc geometry ─────────────────────────────────────────────────────────────
// Convention: 0° = 12 o'clock, clockwise (same as feezal-element-circle-climate).
...
// ─── Element ──────────────────────────────────────────────────────────────────
class FeezalElementCircleHumidifier extends FeezalElement {
    static get feezal() {
        return {
...
customElements.define('feezal-element-circle-humidifier', FeezalElementCircleHumidifier);
export {FeezalElementCircleHumidifier};
