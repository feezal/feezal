...
class FeezalElementPaperAppLayout extends FeezalPolymerElement {
    static get template() {
        return html`
    ...
    static get feezal() {
        return {
            ...
            attributes: [
                'subscribe',
                'publish',
                {name: 'view', dropdown: 'views', label: 'Initial view'},
                {name: 'viewDrawer', type: 'boolean', label: 'Show drawer'},
                {name: 'viewHeader', type: 'boolean', label: 'Show header'},
                {name: 'headerReveals', type: 'boolean', label: 'Header reveals on scroll'},
                {name: 'headerEffects', label: 'Header scroll effects'},
            ],
            baseAttribute: 'view',
            styles: [
                '--app-drawer-width',
