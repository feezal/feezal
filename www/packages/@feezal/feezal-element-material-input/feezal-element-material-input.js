...
customElements.define('feezal-element-material-input', FeezalElementMaterialInput);
// Backward-compat alias — existing dashboards using the old tag keep working.
if (!customElements.get('feezal-element-material-text-field')) {
    console.warn('[feezal] feezal-element-material-text-field is deprecated; use feezal-element-material-input instead.');
    customElements.define('feezal-element-material-text-field', class extends FeezalElementMaterialInput {});
}
export {FeezalElementMaterialInput};
