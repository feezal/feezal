    ...
    static get feezal() {
        return {
            ...
            attributes: [
                ...
                {name: 'text-open',   type: 'string', default: 'Open', defaultI18n: {de: 'Offen'},   help: 'State text while open.'},
                {name: 'text-closed', type: 'string', default: 'Closed', defaultI18n: {de: 'Geschlossen'}, help: 'State text while closed.'},
                {name: 'text-tilted', type: 'string', default: 'Tilted', defaultI18n: {de: 'Gekippt'}, help: 'State text while tilted.'},
