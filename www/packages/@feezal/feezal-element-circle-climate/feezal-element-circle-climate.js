...
// ─── Arc geometry ─────────────────────────────────────────────────────────────
// Convention: 0° = 12 o'clock, clockwise (same as feezal-element-circle-light).
...
// ─── Element ──────────────────────────────────────────────────────────────────
class FeezalElementCircleClimate extends FeezalElement {
    static get feezal() {
        return {
            ...
            // ── N6 custom inspector ───────────────────────────────────────────
            inspector: 'feezal-element-circle-climate-inspector',
...
customElements.define('feezal-element-circle-climate', FeezalElementCircleClimate);
export {FeezalElementCircleClimate};
...
class FeezalElementCircleClimateInspector extends LitElement {
    static properties = {
...
customElements.define('feezal-element-circle-climate-inspector', FeezalElementCircleClimateInspector);
export {FeezalElementCircleClimateInspector};
