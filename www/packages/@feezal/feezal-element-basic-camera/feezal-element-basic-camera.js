    ...
    static get feezal() {
        return {
            ...
            attributes: [
                ...
                {name: 'chips', type: 'objectList', default: '[]', section: 'Chips', itemFields: [
                    {key: 'subscribe', type: 'mqttTopic', placeholder: 'frigate/cam/person'},
                    {key: 'label', placeholder: 'Person'},
                    {key: 'message-property', placeholder: 'payload'},
                    {key: 'show', type: 'select', options: ['always', 'nonzero']},
                ], help: 'State chips over the feed — one entry per chip: subscribe (topic), label, message-property (default payload), show = always | nonzero (hidden while 0/off/empty).'},
