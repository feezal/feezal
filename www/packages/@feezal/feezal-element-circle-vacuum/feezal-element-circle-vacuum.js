...
// ─── Element ──────────────────────────────────────────────────────────────────
class FeezalElementCircleVacuum extends FeezalElement {
    static get feezal() {
        return {
            palette: {name: 'Vacuum', category: 'Circle', color: '#1565c0', icon: 'cleaning_services'},
    ...
    static properties = {
        ...
        showLocate:         {type: Boolean, reflect: true, converter: feezalBoolean, attribute: 'show-locate'},
...
customElements.define('feezal-element-circle-vacuum', FeezalElementCircleVacuum);
export {FeezalElementCircleVacuum};
