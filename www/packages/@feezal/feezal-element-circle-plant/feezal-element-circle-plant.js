...
// ── Element ───────────────────────────────────────────────────────────────────
class FeezalElementCirclePlant extends FeezalElement {
    static get feezal() {
        return {
            palette: {name: 'Plant', category: 'Circle', color: '#1565c0', icon: 'local_florist'},
    ...
    static properties = {
        ...
        showBattery:           {type: Boolean, reflect: true, converter: feezalBoolean, attribute: 'show-battery'},
...
customElements.define('feezal-element-circle-plant', FeezalElementCirclePlant);
export {FeezalElementCirclePlant};
