    ...
    static get feezal() {
        return {
            ...
            attributes: [
                ...
                {name: 'label-on',    type: 'string', default: 'ON', defaultI18n: {de: 'EIN', es: 'ENCENDIDO', fr: 'ALLUMÉ', it: 'ACCESO', pl: 'WŁĄCZONY', pt: 'LIGADO', tr: 'AÇIK'},  help: 'Engraved marker at the ON position (empty = none).'},
                {name: 'label-off',   type: 'string', default: 'OFF', defaultI18n: {de: 'AUS', es: 'APAGADO', fr: 'ÉTEINT', it: 'SPENTO', pl: 'WYŁĄCZONY', pt: 'DESLIGADO', tr: 'KAPALI'}, help: 'Engraved marker at the OFF position (empty = none).'},
