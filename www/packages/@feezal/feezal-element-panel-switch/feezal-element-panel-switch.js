    ...
    static get feezal() {
        return {
            ...
            attributes: [
                ...
                {name: 'label-on',    type: 'string', default: 'ON', defaultI18n: {de: 'EIN'},  help: 'Engraved marker at the ON position (empty = none).'},
                {name: 'label-off',   type: 'string', default: 'OFF', defaultI18n: {de: 'AUS'}, help: 'Engraved marker at the OFF position (empty = none).'},
