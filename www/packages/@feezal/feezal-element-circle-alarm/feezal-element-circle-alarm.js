...
// ─── Element ────────────────────────────────────────────────────────────────
class FeezalElementCircleAlarm extends FeezalElement {
    static get feezal() {
        return {
            palette: {name: 'Alarm', category: 'Circle', color: '#1565c0', icon: 'security'},
    ...
    static properties = {
        ...
        requireCodeToArm: {type: Boolean, reflect: true, converter: feezalBoolean, attribute: 'require-code-to-arm'},
...
customElements.define('feezal-element-circle-alarm', FeezalElementCircleAlarm);
export {FeezalElementCircleAlarm};
