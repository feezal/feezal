    ...
    static get feezal() {
        return {
            ...
            attributes: [
                ...
                {name: 'subscribe', type: 'mqttTopic', help: 'Current temperature topic.'},
                {name: 'message-property', type: 'string', default: 'payload',
                    help: 'Dot-notation path within current-temperature messages. Default: payload'},
                {name: 'subscribe-setpoint', type: 'mqttTopic', help: 'Setpoint state topic.'},
                ...
                {name: 'publish-setpoint', type: 'mqttTopic', help: 'Setpoint command topic (enables the back stepper).'},
                {name: 'step', type: 'number', default: 0.5, help: 'Setpoint stepper increment.'},
                {name: 'min',  type: 'number', default: 5,  help: 'Setpoint minimum.'},
                {name: 'max',  type: 'number', default: 30, help: 'Setpoint maximum.'},
                {name: 'unit', type: 'string', default: '°C', help: 'Temperature unit.'},
                {name: 'subscribe-mode', type: 'mqttTopic', help: 'Mode state topic.'},
                {name: 'message-property-mode', type: 'string', default: 'payload',
                    help: 'Dot-notation path within mode messages. Default: payload'},
                {name: 'publish-mode', type: 'mqttTopic', help: 'Mode command topic (enables the back mode chips).'},
                {name: 'modes', type: 'objectList', itemFields: [{key: '', placeholder: 'heat'}],
