...
/**
 * feezal-element-connection-status
 *
 ...
 */
class FeezalElementConnectionStatus extends LitElement {
    static get feezal() {
        return {
            palette: {
...
window.customElements.define('feezal-element-connection-status', FeezalElementConnectionStatus);
