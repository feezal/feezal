...
const SITE_HTML =
    ...
    `<feezal-element-basic-camera id="cam-pub" type="image" src="${PIXEL}" click-action="publish" publish="cam/cmd" payload="snap" style="position:absolute;top:20px;left:20px;width:160px;height:100px;"></feezal-element-basic-camera>` +
    `<feezal-element-basic-camera id="cam-pop" type="image" src="${PIXEL}" click-action="popup" label="garden" style="position:absolute;top:20px;left:220px;width:160px;height:100px;"></feezal-element-basic-camera>` +
    ...
    `<feezal-element-basic-camera id="cam-thru" type="image" src="${PIXEL}" click-through style="position:absolute;top:160px;left:20px;width:160px;height:60px;"></feezal-element-basic-camera>` +
    `<feezal-element-basic-camera id="cam-anim" type="image" src="${PIXEL}" click-action="popup" popup-animation style="position:absolute;top:160px;left:220px;width:160px;height:100px;"></feezal-element-basic-camera>` +
...
describe('webrtc (WHEP loopback)', () => {
    ...
    const RTC_HTML =
        '<feezal-site><feezal-view name="main" style="width:100%;height:100%;">' +
        '<feezal-element-basic-camera id="cam-rtc" type="webrtc" src="/fake-whep/cam" click-action="popup" style="position:absolute;top:20px;left:20px;width:320px;height:180px;"></feezal-element-basic-camera>' +
        '</feezal-view></feezal-site>';
