...
beforeAll(async () => {
    ...
    // AND the U81 connect-setup dialog seen server-side (else they auto-start
    // on the broker-less empty site and their modal overlay blocks the
    // editor), and start with all palette categories expanded (new-user
    // default collapses everything but "Basic", which would hide the
