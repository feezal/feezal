...
- [E182 — echo2mqtt discovery + the media-element capability gaps (mute, provider, dedupe)](#e182-echo2mqtt-discovery-the-media-element-capability-gaps-mute-provider-dedupe)
- [E183 — glass-media element](#e183-glass-media-element)
...
### E182 — echo2mqtt discovery + the media-element capability gaps (mute, provider, dedupe)
