...
3. Any LIVE connection — server bridge or the browser's own direct
   broker connection — suppresses the wizard outright (direct-MQTT
   setups used to be nagged on every load).
